  ...
  <div class="personal-details-page">
    <div class="personal-details-card p-3">
      ...
      <div class="input_form my-2">
        <label for="old_password" class="small fw-medium">Current password</label>
        <input type="password" class="w-100" id="ld_password" v-model="current_password" />
      </div>

      <div class="input_form my-2">
        <label for="new_password" class="small fw-medium">New Password</label>
        <input type="password" class="w-100" id="new_password" v-model="new_password" />
      </div>

      <div class="input_form my-2">
        <label for="confirm_password" class="small fw-medium">Confirm Password</label>
        <input type="password" class="w-100" id="confirm_password" v-model="confirm_password" />
      </div>
